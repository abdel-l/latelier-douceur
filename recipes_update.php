...
if (!isset($getData['id']) || !is_numeric($getData['id'])) {
    echo('Il faut un identifiant de dessert pour le modifier.');
    return;
}
...
<head>
    ...
    <title>L'Atelier Douceur - Modifier un dessert</title>
...
<body class="d-flex flex-column min-vh-100">
    ...
    <div class="container my-5">
        <div class="row justify-content-center">
            <div class="col-md-7">
                <h1 class="fw-bold mb-4">Modifier le dessert</h1>
                <div class="card">
                    <div class="card-body p-4">
                        <form action="recipes_post_update.php" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="recipe" name="recipe" rows="8"><?php echo htmlspecialchars($recipe['recipe']); ?></textarea>
                            </div>
